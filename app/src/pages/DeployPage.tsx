...
import programSource from "../../../build/test_zebec_payroll_v6/test_zebec_payroll_v6.aleo?raw";
  ...
  return (
    <section className="card">
      ...
      <p className="muted" style={{ fontSize: "0.85rem" }}>
        Deploys <code>build/test_zebec_payroll_v6/test_zebec_payroll_v6.aleo</code> (
