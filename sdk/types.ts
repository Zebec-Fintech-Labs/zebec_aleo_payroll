/**
 * TypeScript mirrors of the Leo structs in `test_zebec_payroll_v2.aleo` (see
...
export interface PayrollClientOptions {
  ...
  host?: string;
  /** Program id. Defaults to `test_zebec_payroll_v2.aleo`. */
  programId?: string;
  /** Private key of the transacting account (`APrivateKey1...`). */
  privateKey?: string;
  /**
   * Compiled program source (`build/test_zebec_payroll_v2/test_zebec_payroll_v2.aleo`). When
